...
const steps = [
  {
    ...
    description:
      'Evaluamos el espacio y tomamos medidas para planificar el diseño y la instalación.',
  },
  {
    number: '02',
    icon: Calculator,
  ...
  },
  {
    ...
    description:
      'Instalamos tus muebles y completamos los trabajos contemplados en el alcance acordado.',
  },
];
      ...
      <div className="mx-auto max-w-[1584px]">
        ...
        <div className="grid grid-cols-1 items-stretch lg:min-h-[850px] lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-6 md:px-12">
            ...
            <Reveal delay={100}>
              <div className="mb-10">
                <p className="mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-[#816037]">
                  Cómo trabajamos
                </p>

                <h2 className="max-w-lg text-black section-title">
            ...
            <div className="flex flex-col gap-5">
              {steps.map((step, index) => (
                <Reveal key={step.number} delay={200 + index * 140}>
                  <div className="flex items-start gap-3 sm:items-center sm:gap-4">
                    {/* NÚMERO */}
                    <div className="flex h-[54px] min-w-[54px] items-center justify-center rounded-full bg-[#D9B37A] text-sm font-bold text-black shadow-md">
                      {step.number}
                    </div>
                    ...
                    {/* ICONO */}
                    <div className="hidden w-8 shrink-0 justify-center sm:flex">
                      <step.icon
                        size={32}
                        strokeWidth={1.7}
            ...
            <Reveal delay={950}>
              <div className="mt-12">
                <Link
                  ...
                  className="group inline-flex items-center gap-3 rounded-xl bg-[#D9B37A] px-7 py-4 text-base font-semibold text-black shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#C9A66B] hover:shadow-md md:text-lg"
                >
                  {ctaLabel}
