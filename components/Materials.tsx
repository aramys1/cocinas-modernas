...
const defaultMaterials: MaterialItem[] = [
  {
    ...
    description:
      'Tableros resistentes a la humedad para muebles de uso diario.',
  ...
  },
  {
    ...
    description: 'Piedra natural de alta resistencia y elegancia.',
    image: '/granito.png',
  ...
  },
  {
    ...
    description: 'Superficies modernas con acabados premium.',
    image: '/cuarzo.png',
  ...
  },
  {
    ...
    description: 'Iluminación funcional para crear ambientes únicos.',
    image: '/luces-led.png',
  ...
  },
  {
    ...
    description: 'Bisagras y accesorios de alta calidad.',
    image: '/herraje.png',
  ...
  },
  {
    ...
    description: 'Soluciones inteligentes para aprovechar cada rincón.',
      ...
      <div className="mx-auto max-w-[1584px] px-6 md:px-12">
        ...
        <Reveal>
          <div className="mb-14 text-center">
            ...
            <h2
              className="mx-auto max-w-4xl text-black section-title"
              style={{
        ...
        >
          {materials.map((item, index) => (
            <Reveal key={item.title} delay={index * 120} className="h-full">
              <article className="group h-full overflow-hidden rounded-3xl bg-white shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-xl">
                {/* IMAGEN */}
                <div className="relative h-[170px] overflow-hidden">
                  <Image
                    ...
                    sizes={
                      materials.length >= 6
                        ? '(max-width: 639px) 100vw, (max-width: 767px) 50vw, (max-width: 1279px) 33vw, 240px'
                        : '(max-width: 639px) 100vw, (max-width: 1279px) 50vw, 350px'
                    }
                ...
                <div className="relative flex justify-center">
                  <div className="absolute -top-7 z-10 flex h-14 w-14 items-center justify-center rounded-full border-4 border-white bg-[#D9B37A] shadow-lg">
                    <item.icon
                      size={24}
                      strokeWidth={1.8}
